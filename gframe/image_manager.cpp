...
bool ImageManager::Initial() {
	...
	GET_TEXTURE(tBtn1, "btn1")
	GET_TEXTURE(tBtn2, "btn2")
	GET_TEXTURE(tBtn3, "btn3")
	GET_TEXTURE(tBtn4, "btn4")
	GET_TEXTURE(tBtn5, "btn5")
	GET_TEXTURE(tBtn6, "btn6")
	GET_TEXTURE(tBtnr1, "btnr1")
	GET_TEXTURE(tBtnr2, "btnr2")
	GET_TEXTURE(tBtnr3, "btnr3")
	GET_TEXTURE(tBtnr4, "btnr4")
	GET_TEXTURE(tBtnr5, "btnr5")
	GET_TEXTURE(tBtnr6, "btnr6")
	GET_TEXTURE(btnInfo, "btnInfo")
	GET_TEXTURE(btnLog, "btnLog")
	GET_TEXTURE(btnHelper, "btnHelper")
	GET_TEXTURE(btnSystem, "btnSystem")
	//YGOPROESEND
