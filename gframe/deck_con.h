...
public:
	enum limitation_search_filters {
		...
		LIMITATION_FILTER_ONE_HUNDRED_POINTS,
		LIMITATION_FILTER_NINETY_SEVEN_POINTS,
		LIMITATION_FILTER_NINETY_FIVE_POINTS,
		LIMITATION_FILTER_NINETY_FOUR_POINTS,
		LIMITATION_FILTER_NINETY_THREE_POINTS,
		LIMITATION_FILTER_NINETY_ONE_POINTS,
		LIMITATION_FILTER_NINETY_POINTS,
		LIMITATION_FILTER_EIGHTY_EIGHT_POINTS,
		LIMITATION_FILTER_EIGHTY_SEVEN_POINTS,
		LIMITATION_FILTER_EIGHTY_FIVE_POINTS,
		LIMITATION_FILTER_EIGHTY_ONE_POINTS,
		LIMITATION_FILTER_EIGHTY_POINTS,
		LIMITATION_FILTER_SEVENTY_SEVEN_POINTS,
		LIMITATION_FILTER_SEVENTY_FIVE_POINTS,
		LIMITATION_FILTER_SEVENTY_POINTS,
		LIMITATION_FILTER_SIXTY_SEVEN_POINTS,
		LIMITATION_FILTER_SIXTY_SIX_POINTS,
		LIMITATION_FILTER_SIXTY_FIVE_POINTS,
		LIMITATION_FILTER_SIXTY_ONE_POINTS,
		LIMITATION_FILTER_SIXTY_POINTS,
		LIMITATION_FILTER_FITHY_FIVE_POINTS,
		LIMITATION_FILTER_FITHY_POINTS,
		LIMITATION_FILTER_FOURTY_FIVE_POINTS,
		LIMITATION_FILTER_FOURTY_POINTS,
		LIMITATION_FILTER_THIRTY_THREE_POINTS,
		LIMITATION_FILTER_THIRTY_ONE_POINTS,
		LIMITATION_FILTER_THIRTY_POINTS,
		LIMITATION_FILTER_TWENTY_SEVEN_POINTS,
		LIMITATION_FILTER_TWENTY_FIVE_POINTS,
		LIMITATION_FILTER_TWENTY_TWO_POINTS,
		LIMITATION_FILTER_TWENTY_ONE_POINTS,
		LIMITATION_FILTER_TWENTY_POINTS,
		LIMITATION_FILTER_FIFTHTEEN_POINTS,
		LIMITATION_FILTER_THIRTHTEN_POINTS,
		LIMITATION_FILTER_ELEVEN_POINTS,
		LIMITATION_FILTER_TEN_POINTS,
		LIMITATION_FILTER_SEVEN_POINTS,
		LIMITATION_FILTER_FIVE_POINTS,
		LIMITATION_FILTER_THREE_POINTS,
		LIMITATION_FILTER_TWO_POINTS,
		LIMITATION_FILTER_ONE_POINT,
		LIMITATION_FILTER_ZERO_POINTS
	};
