...
DECLR(DECK_WINDOW_EXTRA_INFO_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_EXTRA_INFO_TOP_RIGHT, 0x99000000)
DECLR(DECK_WINDOW_EXTRA_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_EXTRA_TOP_RIGHT, 0x99000000)
...
DECLR(DECK_WINDOW_MAIN_INFO_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_MAIN_INFO_TOP_RIGHT, 0x99000000)
DECLR(DECK_WINDOW_MAIN_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_MAIN_TOP_RIGHT, 0x99000000)
...
DECLR(DECK_WINDOW_SEARCH_RESULT_INFO_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_SEARCH_RESULT_INFO_TOP_RIGHT, 0x400000ffL)
DECLR(DECK_WINDOW_SEARCH_RESULT_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_SEARCH_RESULT_TOP_RIGHT, 0x99000000)
...
DECLR(DECK_WINDOW_SIDE_INFO_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_SIDE_INFO_TOP_RIGHT, 0x99000000)
DECLR(DECK_WINDOW_SIDE_TOP_LEFT, 0x99000000)
DECLR(DECK_WINDOW_SIDE_TOP_RIGHT, 0x99000000)
...
DECLR(DUELFIELD_HIGHLIGHTING_CARD_OUTLINE, CLR(255, 255, 255, 0))
...
DECLR(DUELFIELD_SELECTABLE_FIELD_OUTLINE, CLR(255, 255, 255, 0))
