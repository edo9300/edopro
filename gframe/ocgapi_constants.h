...
#define DUEL_MODE_GENESYS      (DUEL_FSX_MMZONE | DUEL_TRAP_MONSTERS_NOT_USE_ZONE | DUEL_TRIGGER_ONLY_IN_LOCATION)
...
#define DUEL_MODE_GENESYS_FORB (TYPE_PENDULUM | TYPE_LINK)
